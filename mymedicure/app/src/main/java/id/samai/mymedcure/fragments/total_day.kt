...
import id.samai.mymedcure.adapters.total_day_Adapter
 ...
 * Use the [total_day.newInstance] factory method to
 * create an instance of this fragment.
 */
class total_day : Fragment() {
    ...
    override fun onCreateView(
        ...
        view = (inflater.inflate(R.layout.fragment_total_day, container, false) as ViewGroup).apply {
    ...
    private fun initRecylerView(view: View) {
        view.apply {
            ...
            val schedules = context.dbHelper.getScheduleDay(day)
            ...
            if (schedules.isEmpty()) {
                ...
                val scheduleAdapter = total_day_Adapter(context, schedules)
