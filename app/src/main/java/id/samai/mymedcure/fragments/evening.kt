...
import id.samai.mymedcure.adapters.eveningAdapter
 ...
 * Use the [evening.newInstance] factory method to
 * create an instance of this fragment.
 */
class evening : Fragment() {
    ...
    override fun onCreateView(
        ...
        view = (inflater.inflate(R.layout.fragment_evening, container, false) as ViewGroup).apply {
    ...
    private fun initRecylerView(view: View) {
        view.apply {
            ...
            val schedules = context.dbHelper.getScheduleEvening(day)
            ...
            if (schedules.isEmpty()) {
                ...
                val scheduleAdapter = eveningAdapter(context, schedules)
